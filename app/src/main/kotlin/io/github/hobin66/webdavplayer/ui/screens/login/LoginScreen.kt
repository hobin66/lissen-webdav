package io.github.hobin66.webdavplayer.ui.screens.login
...
import io.github.hobin66.webdavplayer.channel.common.makeText
...
import io.github.hobin66.webdavplayer.viewmodel.LoginViewModel
import io.github.hobin66.webdavplayer.viewmodel.LoginViewModel.LoginState
    ...
    content = { innerPadding ->
      Box(
        ...
        Column(
          ...
          OutlinedTextField(
            value = rootPath,
            onValueChange = { viewModel.setRootPath(it.trim()) },
            keyboardOptions = KeyboardOptions(keyboardType = KeyboardType.Uri),
            label = { Text(stringResource(R.string.login_screen_root_path_input)) },
            shape = RoundedCornerShape(16.dp),
            singleLine = true,
            modifier =
              Modifier
        ...
        Text(
          ...
          text = stringResource(R.string.login_screen_server_requirements_hint),
          style =
