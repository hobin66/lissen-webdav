    ...
    override fun onConnect(
      ...
      val previousChapterButton =
        CommandButton
          ...
          .setDisplayName(context.getString(R.string.media_session_previous_chapter))
          .setEnabled(true)
      ...
      val nextChapterButton =
        CommandButton
          ...
          .setDisplayName(context.getString(R.string.media_session_next_chapter))
      ...
      val rewindButton =
        CommandButton
          ...
          .setDisplayName(context.getString(R.string.media_session_rewind))
          .setEnabled(true)
      ...
      val forwardButton =
        CommandButton
          ...
          .setDisplayName(context.getString(R.string.media_session_forward))
          .setSlots(CommandButton.SLOT_OVERFLOW)
          .setEnabled(true)
          .build()
