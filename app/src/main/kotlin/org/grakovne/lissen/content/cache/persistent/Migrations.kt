...
val MIGRATION_18_19 =
  object : Migration(18, 19) {
    override fun migrate(db: SupportSQLiteDatabase) {
      db.execSQL("ALTER TABLE detailed_books ADD COLUMN introSkipSeconds INTEGER NOT NULL DEFAULT 0")
      db.execSQL("ALTER TABLE detailed_books ADD COLUMN outroSkipSeconds INTEGER NOT NULL DEFAULT 0")
    }
  }
...
val MIGRATION_19_20 =
  object : Migration(19, 20) {
    override fun migrate(db: SupportSQLiteDatabase) {
      db.execSQL(
        """
        CREATE TABLE IF NOT EXISTS book_skip_settings (
            bookId TEXT NOT NULL PRIMARY KEY,
            introSkipSeconds INTEGER NOT NULL,
            outroSkipSeconds INTEGER NOT NULL
        )
        """.trimIndent(),
      )
    }
