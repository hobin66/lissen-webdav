...
import io.github.hobin66.webdavplayer.content.cache.persistent.withRuntimeBookSkipSettings
...
import io.github.hobin66.webdavplayer.playback.BookSkipSettings
...
class CachedBookDaoSkipUpdateTest {
  ...
  private class RecordingCachedBookDao(
    ...
    override suspend fun deleteAllBookFiles() {
      files = emptyList()
    }

    override suspend fun deleteAllBookChapters() {
      chapters = emptyList()
    }

    override suspend fun deleteAllMediaProgress() = Unit
